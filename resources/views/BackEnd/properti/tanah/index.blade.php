                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <div class="card">
                                                <div class="card-header table-card-header">
                                                    <h5>Data Tanah</h5><br><br>
                                                    <a href="{{route('tanah.add')}}" class="btn btn-sm btn-primary">Tambah</a>
                                                </div>
                                                    ...
                                                    <div class="dt-responsive table-responsive">
                                                        <table id="basic-btn" class="table table-striped table-bordered nowrap">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>{{$value->land_size}}</td>
                                                                <td>
                                                                    <a href="{{route('tanah.show', $value->property_id)}}" class="btn btn-sm btn-success">Edit</a>
