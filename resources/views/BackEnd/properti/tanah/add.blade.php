                                                    ...
                                                    <div class="card-block">
                                                        <form action="{{route('tanah.store')}}" method="post">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <input type="text" class="form-control" placeholder="e.g 14" name="land_size" id="land_size">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <select name="status" id="status" class="form-control">
                                                                        ...
                                                                        <option value="jualsewa">Jual/Sewa</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group" style="display: none" id="jual">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <input type="text" class="form-control" placeholder="e.g 125JT" name="cash_price" id="cash_price">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group status2" style="display: none" id="sewa">
                                                                <label class="col-sm-12 col-form-label">Harga Sewa</label>
                                                                    <div class="col-sm-12">
                                                                        <input type="text" class="form-control" placeholder="e.g 125/Tahun" name="rent_price" id="rent_price">
                                                                    </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <input type="text" class="form-control" placeholder="e.x -09.001231" name="lat" id="lat">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <input type="text" class="form-control" placeholder="e.x 16.012111" name="long" id="long">
                                                                </div>
                                                            </div>
