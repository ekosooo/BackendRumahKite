                                            ...
                                            <div class="card">
                                                <div class="card-header">
                                                    ...
                                                    <div class="card-block">
                                                        <form action="{{route('skill.post')}}" method="post">
                                                            {{csrf_field()}}
                                                            <input type="hidden" id="handyman_latest" name="handyman_latest" value="{{$handyman_latest}}">
                                                            @foreach($skill as $value)
                                                                <div class="form-check">
                                                                    <input type="checkbox" class="form-check-input" id="skill_id" name="skill_id[]" value="{{$value->skill_id}}">
