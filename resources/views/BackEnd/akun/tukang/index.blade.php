                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <div class="card">
                                                <div class="card-header table-card-header">
                                                    <h5>Data Tukang</h5><br><br>
                                                    <a href="{{route('tukang.add')}}" class="btn btn-sm btn-primary">Tambah</a>
                                                </div>
                                                    ...
                                                    <div class="dt-responsive table-responsive">
                                                        <table id="basic-btn" class="table table-striped table-bordered nowrap">
                                                            ...
                                                            @foreach($tukang as $value)
                                                                <tr>
                                                                    <td>{{++$i}}</td>
                                                                    <td>{{$value->handyman_name}}</td>
                                                                    <td>{{$value->handyman_phone}}</td>
                                                                    <td>{{$value->handyman_price}}</td>
                                                                    <td>
