                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <div class="card">
                                                <div class="card-header table-card-header">
                                                    <h5>Data Mitra</h5><br><br>
                                                    <a href="{{route('company.add')}}" class="btn btn-sm btn-primary">Tambah</a>
                                                </div>
                                                        ...
                                                        <table id="basic-btn" class="table table-striped table-bordered nowrap">
                                                            ...
                                                            @foreach($company as $value)
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <a href="{{route('company.show', $value->company_id)}}" class="btn btn-sm btn-success">Edit</a>
